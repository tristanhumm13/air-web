    ...
    : PageModel
{
    ...
    [BindProperty]
    public ContactUpdateDto ContactUpdate { get; set; } = null!;

    [BindProperty]
    public PhoneNumberCreate NewPhoneNumber { get; set; } = null!;
    ...
    public async Task<IActionResult> OnGetAsync(Guid? id)
    {
        ...
        TempData.AddDisplayMessage(DisplayMessage.AlertContext.Info, "Cannot edit a deleted customer or contact.");
    ...
    public async Task<IActionResult> OnPostSaveContactAsync()
    {
        ...
        HighlightId = Id;
        TempData.AddDisplayMessage(DisplayMessage.AlertContext.Success, "Contact successfully updated.");
